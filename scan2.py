...
def test_scan(path_img):
	...
	#ans_1_30 = get_ans('1_30', crop_1_30_img)
...
def get_block_points(input_img):
	...
	top_left = (first_row_x, first_col_y)
	top_right = (last_row_x + last_row_w, first_col_y)
	bottom_right = (last_row_x + last_row_w, last_row_y)
	bottom_left = (first_row_x, first_row_y)
